...
public class RequestedListFragment extends Fragment implements CustomRecyclerCallBacks  {



    private static RequestedListFragment linkedlistfragment;
    ...
    public static RequestedListFragment getInstance(BaseActivity activityReference, BasePreferenceHelper preferenceHelper, ArrayList<CompanyHeadModel> LinkList ) {
        if (linkedlistfragment == null) {
            linkedlistfragment = new RequestedListFragment();
        }
