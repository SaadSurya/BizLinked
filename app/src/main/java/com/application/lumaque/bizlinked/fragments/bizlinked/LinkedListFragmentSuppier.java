...
public class LinkedListFragmentSuppier extends Fragment implements CustomRecyclerCallBacks {


    private static LinkedListFragmentSuppier linkedlistfragment;
    ...
    public static LinkedListFragmentSuppier getInstance(BaseActivity activityReference, BasePreferenceHelper preferenceHelper, ArrayList<CompanyHeadModel> LinkList) {
        if (linkedlistfragment == null) {
            linkedlistfragment = new LinkedListFragmentSuppier();
        }
